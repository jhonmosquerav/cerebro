...
## 2026-06-25
- `EVOLVE` (compuerta) — `gen-auto-auditoria` **v3**: cierra las 2 fricciones que destapó la corrida v2 — confidencialidad cubre todo el artefacto (incl. `diff`/descripción), y desempate determinista entre clases de igual severidad. Sin fricciones abiertas.
